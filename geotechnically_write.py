...
# value list to be modified and referred to for document creatio
...
resume_img_scaled1 = pygame.transform.scale(resume_img, (2000, 400))
resume_img_scaled2 = pygame.transform.scale(resume_img, (5000, 600))
resume_img_scaled3 = pygame.transform.scale(resume_img, (7000, 600))
resume_img_scaled4 = pygame.transform.scale(resume_img, (3000, 400))

clicked_resume_img_scaled1 = pygame.transform.scale(clicked_resume_img, (2000, 400))
clicked_resume_img_scaled2 = pygame.transform.scale(clicked_resume_img, (5000, 400))
clicked_resume_img_scaled3 = pygame.transform.scale(clicked_resume_img, (7000, 400))
clicked_resume_img_scaled4 = pygame.transform.scale(clicked_resume_img, (3000, 400))

clicked_resume_img2 = pygame.image.load("dark_blue.bmp")

clicked_resume_img3 = pygame.image.load("dark_blue.bmp")
clicked_resume_img4 = pygame.image.load("dark_blue.bmp")
...
start_button = Button(330, 182, resume_img_scaled2, .1)
learning_start_button = Button(233, 308, resume_img_scaled3, .1)
...
great_valley_button = Button(55, 135, resume_img_scaled1, .1)
great_valley_button_clicked = Button(55, 135, clicked_resume_img_scaled1, .1)
modoc_button = Button(55, 185, resume_img_scaled1, .1)
modoc_button_clicked = Button(55, 185, clicked_resume_img_scaled1, .1)
sierra_button = Button(55, 235, resume_img_scaled1, .1)
sierra_button_clicked = Button(55, 235, clicked_resume_img_scaled1, .1)
klamath_button = Button(370, 135, resume_img_scaled1, .1)
klamath_button_clicked = Button(370, 135, clicked_resume_img_scaled1, .1)
transverse_button = Button(370, 185, resume_img_scaled1, .1)
transverse_button_clicked = Button(370, 185, clicked_resume_img_scaled1, .1)
cascade_button = Button(370, 235, resume_img_scaled1, .1)
cascade_button_clicked = Button(370, 235, clicked_resume_img_scaled1, .1)
coast_button = Button(670, 135, resume_img_scaled1, .1)
coast_button_clicked = Button(670, 135, clicked_resume_img_scaled1, .1)
peninsular_button = Button(670, 185, resume_img_scaled1, .1)
peninsular_button_clicked = Button(670, 185, clicked_resume_img_scaled1, .1)
basin_range_button = Button(670, 235, resume_img_scaled1, .1)
basin_range_button_clicked = Button(670, 235, clicked_resume_img_scaled1, .1)
mojave_button = Button(950, 135, resume_img_scaled1, .1)
mojave_button_clicked = Button(950, 135, clicked_resume_img_scaled1, .1)
colorado_button = Button(950, 185, resume_img_scaled1, .1)
colorado_button_clicked = Button(950, 185, clicked_resume_img_scaled1, .1)
...
gintyes_button = Button(545, 200, resume_img, .1)
...
while run:
  ...
  if project_start == True:
    ...
    if menu_state == "3":
      ...
      event_list = pygame.event.get()
      screen.blit(textflat,(338,65))
      screen.blit(textgentle,(628,65))
      screen.blit(textsteep,(931,65))  
      screen.blit(textgv,(105,150))
      screen.blit(textmp,(97,200))
      screen.blit(textkm,(395,150))
      screen.blit(textsn,(97,250))
      screen.blit(texttr,(420,200))
      screen.blit(textcr,(409,250))
      screen.blit(textcoast,(715,150))
      screen.blit(textpr,(697,200))
      screen.blit(textbr,(702,250))
      screen.blit(textmd,(995,150))
      screen.blit(textcd,(990,200))
    ...
    if menu_state == "5":
      ...
      if gintyes_button.draw(screen):
        ...
        if gintyes == True:
          ...
          project_number_1 = doc.paragraphs[37]
          ...
          client_name_3 = doc.paragraphs[45]
          client_name_3.add_run(text_input_box_client_name.text)
          development_description_4 = doc.paragraphs[46]
          development_description_4.add_run(text_input_box_development_description.text.title())
          address1_2 = doc.paragraphs[49]
          address1_2.add_run(gint_address1)
          address2_2 = doc.paragraphs[50]
          address2_2.add_run(gint_address2_nozip)
          project_number_3 = doc.paragraphs[51]
          project_number_3.add_run(gint_project_number)
          client_name_2 = doc.paragraphs[53]
          client_name_2.add_run(f' {text_input_box_client_name.text},')
          project_address1_1 = doc.paragraphs[55]
          project_address1_1.add_run(f' has prepared a Geotechnical Engineering Study for the proposed {development_description} development at the property located at {gint_address1} in {project_address2}. It is our understanding that the proposed development consists of the construction of a {development_description}.')
          client_business_3 = doc.paragraphs[59]
          ...
          project_address1_2 = doc.paragraphs[107]
          ...
          drilling_info_1 = doc.paragraphs[117]
          ...
          drilling_info_2 = doc.paragraphs[118]
          ...
          liquifaction_1 = doc.paragraphs[169]
          ...
          liquifaction_2 = doc.paragraphs[171]
          ...
          dynamic_compaction_1 = doc.paragraphs[173]
          ...
          seismic_coeffecients_1 = doc.paragraphs[185]
          ...
          geomorphic_region1 = doc.paragraphs[12]
          if coast == True:            
