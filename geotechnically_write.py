...
text4 = text_font.render('Client Address Line 1, 123 Fake St', False, 'Blue')
text5 = text_font.render('Client Address Line 2, Ice Cream Island, Alaska 12345', False, 'Blue')
...
#seismic variables
site_class = text_input_box_site_class
site_class_description = ''
ss = text_input_box_ss
s1 = text_input_box_s1
fa = text_input_box_fa
fv = text_input_box_fv
sms = text_input_box_sms
sm1 = text_input_box_sm1
sds = text_input_box_sds
sd1 = text_input_box_sd1
